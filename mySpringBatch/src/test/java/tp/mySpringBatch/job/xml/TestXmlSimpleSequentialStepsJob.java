...
class SimpleSequentialStepsXmlTestConfig{
}

@SpringBatchTest
@SpringBootTest(classes = { SimpleSequentialStepsXmlTestConfig.class } )
@ActiveProfiles(profiles = {"xmlJobConfig"})
public class TestXmlSimpleSequentialStepsJob extends AbstractBasicActiveTestJob {
