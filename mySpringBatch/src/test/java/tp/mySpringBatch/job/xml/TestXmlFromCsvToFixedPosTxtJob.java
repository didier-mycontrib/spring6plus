...
class FromCsvToFixedPosTxtXmlTestConfig{
}

@SpringBatchTest
@SpringBootTest(classes = { FromCsvToFixedPosTxtXmlTestConfig.class } )
@ActiveProfiles(profiles = {"xmlJobConfig"})
public class TestXmlFromCsvToFixedPosTxtJob extends AbstractBasicActiveTestJob {
