...
class FromCsvWithSkipsErrorsToJsonXmlTestConfig{
}

@SpringBatchTest
@SpringBootTest(classes = { FromCsvWithSkipsErrorsToJsonXmlTestConfig.class } )
@ActiveProfiles(profiles = {"xmlJobConfig"})
public class TestXmFromCsvWithSkipsErrorsToJsonJob extends AbstractBasicActiveTestJob {
