...
@Import({AutomaticSpringBootBatchJobRepositoryConfig.class,
	MyFixedPosTxtToCsvJobConfig.class ,
	MyCsvFilePersonWriterConfig.class ,
	MyFixedPosTextFilePersonReaderConfig.class,
	SimpleUppercasePersonProcessor.class
	})
class FromFixedPosTxtToCsvTestConfig{
}

@SpringBatchTest
@SpringBootTest(classes = { FromFixedPosTxtToCsvTestConfig.class } )
@ActiveProfiles(profiles = {})
public class TestFromFixedPosTxtToCsvJob extends AbstractBasicActiveTestJob {
