...
class FromJsonToXmlXmlTestConfig{
}

@SpringBatchTest
@SpringBootTest(classes = { FromJsonToXmlXmlTestConfig.class } )
@ActiveProfiles(profiles = {"xmlJobConfig"})
public class TestXmlFromJsonToXmlJob extends AbstractBasicActiveTestJob {
	...
	public void postJobCheckings(){
	   this.verifSameContentExceptedResultFile(
			   "data/expected_output/xml/outputDataV2b.xml", 
