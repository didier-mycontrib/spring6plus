...
import tp.mySpringBatch.reader.java.MyJsonFilePersonReaderConfig;
...
@Import({AutomaticSpringBootBatchJobRepositoryConfig.class,
	MyBasicJsonToXmlJobConfig.class ,
	MyXmlFilePersonWriterConfig.class ,
	MyJsonFilePersonReaderConfig.class,
	SimpleUppercasePersonProcessor.class
	})
class FromJsonToXmlTestConfig{
}

@SpringBatchTest
@SpringBootTest(classes = { FromJsonToXmlTestConfig.class } )
@ActiveProfiles(profiles = {})
public class TestFromJsonToXmlJob extends AbstractBasicActiveTestJob {
	...
	public void postJobCheckings(){
	   this.verifSameContentExceptedResultFile(
			   "data/expected_output/xml/outputDataV2.xml", 
